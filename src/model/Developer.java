...
public class Developer extends Employee {
    ...
    public void showInfor() {
        String str = String.format("%3s_%-25s_%-10d_%s_%s_%d", this.getEmpID(), this.getEmpName(), CompanyManagement.totalSalary(this), this.getTeamName(), this.getProgrammingLanguages(), this.getExpYear());
