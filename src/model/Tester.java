...
import static controller.CompanyManagement.totalSalary;
...
public class Tester extends Employee {
    ...
    public void showInfor() {
        ...
        //có thể dùng để chấm tới totalSalary trong CompanyManagement vì nó require tham số là một object
        String str = String.format("%3s_%-25s_%-10d_%s_%.2f", this.getEmpID(), this.getEmpName(), CompanyManagement.totalSalary(this), this.getType(), this.getBonusRate());
